...
include_once("../modelo/BackpropagationMulticapa.php");
...
class controladorBackpropagationMulticapa {

    public function validarNombre() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {

            if (isset($_POST["nombre"])) {
                return BackpropagationMulticapa::validarNombre($_POST["nombre"]);
            } else {
                return null;
            }
        } else {
    ...
    public function consultaIndividual() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (isset($_POST["nombre"])) {
                return BackpropagationMulticapa::consultaIndividual($_POST["nombre"]);
            } else {
                return null;
            }
        } else {
    ...
    public function lista() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            return BackpropagationMulticapa::consultaGeneral();
        } else {
            return null;
        }
    }
    ...
    public function entrenar() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!isset($_POST["iteraciones"])) {
                ...
                $obj = new BackpropagationMulticapa($_POST["nombre"], $_POST["entradas"], $_POST["salidas"], $_POST["patrones"], $_POST["iteraciones"], $_POST["goal"], $_POST["rata"], $_POST["x"], $_POST["yd"],$_POST["algoritmo"], $_POST["numNeuronaCapas"], $_POST["funcionCapas"]);
                return $obj->entrenar();
            }
        } else {
    ...
    public function simular() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!isset($_POST["m"])) {
                ...
                return BackpropagationMulticapa::simulacion($_POST["m"], $_POST["n"], $_POST["config"], $_POST["u"], $_POST["w"], $_POST["x"]);
            }
        } else {
            $resultado = array('estado' => false, 'mensaje' => "servidor encontrado");
        }
...
switch ($_POST['accion']) {
    case 'entrenar':
        return print(json_encode(controladorBackpropagationMulticapa::entrenar()));
        break;
    case 'reentrenar':
        return print(json_encode(controladorBackpropagationMulticapa::reentrenar()));
        break;

    case 'validarNombre':
        return print(json_encode(controladorBackpropagationMulticapa::validarNombre()));
        break;
    case 'lista':
        return print(json_encode(controladorBackpropagationMulticapa::lista()));
        break;
    case 'consultaIndividual':
        return print(json_encode(controladorBackpropagationMulticapa::consultaIndividual()));
        break;
    case 'simulacion':
        return print(json_encode(controladorBackpropagationMulticapa::simular()));
        break;
    default:
        break;
}
