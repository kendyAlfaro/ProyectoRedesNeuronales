<?php
include_once("../modelo/Backpropagation.php");
header('Content-type: application/json');
header('Access-Control-Allow-Origin:*');
 
$resultado = array();

class controladorBackpropagation {

    public function validarNombre() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {

            if (isset($_POST["nombre"])) {
                return Backpropagation::validarNombre($_POST["nombre"]);
            } else {
                return null;
            }
        } else {
    ...
    public function consultaIndividual() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (isset($_POST["nombre"])) {
                return Backpropagation::consultaIndividual($_POST["nombre"]);
            } else {
                return null;
            }
        } else {
    ...
    public function lista() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            return Backpropagation::consultaGeneral();
        } else {
            return null;
        }
    }
    ...
    public function entrenar() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!isset($_POST["iteraciones"])) {
                ...
                $obj = new Backpropagation($_POST["nombre"], $_POST["entradas"], $_POST["salidas"], $_POST["patrones"], $_POST["iteraciones"], $_POST["goal"], $_POST["rata"], $_POST["x"], $_POST["yd"],$_POST["funcion"]);
    ...
    public function simular() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!isset($_POST["m"])) {
                ...
                return Backpropagation::simulacion($_POST["m"],$_POST["n"],"",$_POST["u"],$_POST["w"],$_POST["x"]);
            }
        } else {
            $resultado = array('estado' => false, 'mensaje' => "servidor encontrado");
        }
...
switch ($_POST['accion']) {
    case 'entrenar':
        return print(json_encode(controladorBackpropagation::entrenar()));
        break;
    case 'reentrenar':
        return print(json_encode(controladorBackpropagation::reentrenar()));
        break;
    case 'validarNombre':
        return print(json_encode(controladorBackpropagation::validarNombre()));
        break;
    case 'lista':
        return print(json_encode(controladorBackpropagation::lista()));
        break;
    case 'consultaIndividual':
        return print(json_encode(controladorBackpropagation::consultaIndividual()));
        break;
    case 'simulacion':
        return print(json_encode(controladorBackpropagation::simular()));
        break;
    default:
        break;
}
