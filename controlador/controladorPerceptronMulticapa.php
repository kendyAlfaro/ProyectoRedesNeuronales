...
include_once("../modelo/PerceptronMulticapa.php");
...
class controladorPerceptronMulticapa {

    public function validarNombre() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {

            if (isset($_POST["nombre"])) {
                return PerceptronMulticapa::validarNombre($_POST["nombre"]);
            } else {
                return null;
            }
        } else {
    ...
    public function consultaIndividual() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (isset($_POST["nombre"])) {
                return PerceptronMulticapa::consultaIndividual($_POST["nombre"]);
            } else {
                return null;
            }
        } else {
    ...
    public function lista() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            return PerceptronMulticapa::consultaGeneral();
        } else {
            return null;
        }
    }
    ...
    public function entrenar() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!isset($_POST["iteraciones"])) {
                ...
                $obj = new PerceptronMulticapa($_POST["nombre"], $_POST["entradas"], $_POST["salidas"], $_POST["patrones"], $_POST["iteraciones"], $_POST["goal"], $_POST["rata"], $_POST["x"], $_POST["yd"],$_POST["algoritmo"], $_POST["numNeuronaCapas"], $_POST["funcionCapas"]);
                return $obj->entrenar();
            }
        } else {
    ...
    public function simular() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!isset($_POST["m"])) {
                ...
                return PerceptronMulticapa::simulacion($_POST["m"], $_POST["n"], $_POST["config"], $_POST["u"], $_POST["w"], $_POST["x"]);
            }
        } else {
            $resultado = array('estado' => false, 'mensaje' => "servidor encontrado");
        }
...
switch ($_POST['accion']) {
    case 'entrenar':
        return print(json_encode(controladorPerceptronMulticapa::entrenar()));
        break;
    case 'reentrenar':
        return print(json_encode(controladorPerceptronMulticapa::reentrenar()));
        break;

    case 'validarNombre':
        return print(json_encode(controladorPerceptronMulticapa::validarNombre()));
        break;
    case 'lista':
        return print(json_encode(controladorPerceptronMulticapa::lista()));
        break;
    case 'consultaIndividual':
        return print(json_encode(controladorPerceptronMulticapa::consultaIndividual()));
        break;
    case 'simulacion':
        return print(json_encode(controladorPerceptronMulticapa::simular()));
        break;
    default:
        break;
}
